...
public class ClassifierDBManager extends Key {
		...
		public ClassifierDBManager() {
			...
			System.out.println(getClass().getClassLoader().getResource("bitcointalk.csv"));
			getClass().getClassLoader().getResource("bitcointalk.csv").getPath();
			
			path = ".." + File.separator  + path + "Bitiodine" + File.separator;
		}
